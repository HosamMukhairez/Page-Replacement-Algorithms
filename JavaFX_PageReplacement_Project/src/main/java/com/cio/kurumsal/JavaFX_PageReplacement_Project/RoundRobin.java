...
public class RoundRobin {
    ...
    static void findWaitingTime(String processes[], int n, String bt[], int wt[], int quantum) {
        // Make a copy of burst times bt[] to store remaining
        // burst times.
        int rem_bt[] = new int[n];
        for (int i = 0; i < n; i++) {
            rem_bt[i] = Integer.parseInt(bt[i]);
        }
    ...
    // Method to calculate turn around time
    static void findTurnAroundTime(String processes[], int n, String bt[], int wt[], int tat[]) {
        // calculating turnaround time by adding
        // bt[i] + wt[i]
        for (int i = 0; i < n; i++) {
            tat[i] = Integer.parseInt(bt[i]) + wt[i];
        }
    }
    ...
    // Method to calculate average time
    public String findavgTime(String processes[], int n, String bt[], int quantum) {
        int wt[] = new int[n], tat[] = new int[n];
        int total_wt = 0, total_tat = 0;
